...
namespace DataAccess
{
    public class UserDA
    {
        ...
        SqlDataAdapter sda;
        SqlDataReader dr;
        public int addstudentinfo(UserBO objBO)
        {
            com = new SqlCommand("Insert", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("StudentName", objBO.StudentName);
            com.Parameters.AddWithValue("DateofBirth", objBO.DateofBirth);
            com.Parameters.AddWithValue("Gender", objBO.Gender);
            com.Parameters.AddWithValue("Degree", objBO.Degree);
            com.Parameters.AddWithValue("Branch", objBO.Branch);
            com.Parameters.AddWithValue("EmailId", objBO.EmailId);
        ...
        public int deletestudentinfo(UserBO objBO)
        {
            com = new SqlCommand("DeleteStudentInfo", con);
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("StudentName", objBO.StudentName);
            con.Open();
            int result = com.ExecuteNonQuery();
       ...
       /* public int updateVendor(UserBO objBO)
        ...
        public string getMobile(UserBO objBO)
        {
            ...
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("name", objBO.StudentName);
            con.Open();
            dr = com.ExecuteReader();
            if (dr.Read())
            {
